...
export default function ProductPage() {
  ...
  return (
    <div className="flex flex-col relative items-center min-h-dvh  w-full max-w-screen px-6 pt-2 pb-30 bg-fk-background/90  scrollbar-none ">
      <div
      ...
      {product && (
        <>
          <main className="w-full flex flex-col mt-16 lg:flex-row scrollbar-none">
            <div className="w-full flex flex-col justify-center lg:w-2/4 lg:px-8">
            ...
            <section className="scrollbar-none md:w-2/4">
